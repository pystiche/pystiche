...
class TestPixelRegularizationOperator:
    def test_call(self):
...
class TestEncodingRegularizationOperator:
    def test_call(self):
...
class TestPixelComparisonOperator:
