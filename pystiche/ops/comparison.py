from typing import Any, Union, Iterator, Sequence, Tuple, Dict
...
from ._ops import ComparisonOperator, EncodingComparisonOperator
...
class DirectComparisonOperator(ComparisonOperator):
    # FIXME remove, just for testing
    def input_image_to_repr(self, image: torch.Tensor, ctx: None) -> torch.Tensor:
        return image
...
#         name: str = "Patch encoding comparison",
...
#         score_weight : float = 1.0,
#     ):
#         super().__init__(name, encoder, layer, score_weight=score_weight)
...
#         return repr, ctx
#
#     def _target_image_transforms(
#         self,
#     ) -> Iterator[TransformMotifAffinely]:
